function HeroSection() {
  return (
    <>
      <div className="flex flex-col md:flex-row justify-center items-center max-w-screen-xl mx-20 md:p-5">
        <div className="flex flex-col w-auto md:w-fit mb-15 md:mb-0 text-[#2e2e2e] me-0 md:me-10 lg:me-25">
          ...
          <a
            href="#planos"
            className="text-white shadow-2xl bg-[#922020] hover:bg-red-900 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium text-2xl md:text-3xl rounded-lg py-3 text-center w-xs"
          >
            Comece a estudar
          </a>
        </div>
